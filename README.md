...
- [...] User can sign up to create a new account using Parse authentication (From Codepath Instructor, Chris Guzman: I've told codepath that the portal and the README conflict. I've suggested that we make the sign up feature an optional story.)
